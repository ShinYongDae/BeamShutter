...
unsigned char g_bAuto, g_bClose, g_bOpen, g_bEnc, g_bConf;
...
28.    EvaRegs.CAPCON.bit.CAPQEPN=01;      //使能捕获单元1,2   
...
32.    EvaRegs.CAPCON.bit.CAP1EDGE=01;     //边沿检测,上升沿   
